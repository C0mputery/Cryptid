...
return {
	descriptions = {
		...
		Blind = {
			bl_cry_box = {
				name = "Коробка",
				text = { "Все обычные джокеры", "ослабляются" },
			},
			bl_cry_clock = {
				name = "Часы",
				text = { "+0.1X минимум очков каждые", "12 секунды в этом анте" },
			},
			bl_cry_hammer = {
				name = "Молоток",
				text = { "Все карты с нечётным", "рангом ослабляются" },
			},
			bl_cry_joke = {
				name = "Шутка",
				text = {
			...
			bl_cry_magic = {
				name = "Магия",
				text = { "Все карты с чётным", "рангом ослабляются" },
			},
			...
			bl_cry_oldarm = {
				...
				text = { "Необходима сыграть 4", "или меньше карт" },
			},
			bl_cry_oldfish = {
				name = "Рыба, Ностальгия",
				text = { "Все руки начинают", "с 1 Множ." },
			},
			...
			bl_cry_oldmanacle = {
				...
				text = { "Разделить Множ. на Сбросы" },
			},
			bl_cry_oldmark = {
				name = "Знак, Ностальгия",
				text = { "Без рук,", "которые содержат пару" },
			},
			bl_cry_oldox = {
				name = "Буйвол, Ностальгия",
				text = { "Все руки начинают", "с нулём фишек" },
			},
			bl_cry_oldpillar = { name = "Столп, Ностальгия", text = { "Без стритов" } },
			bl_cry_oldserpent = {
				name = "Змей, Ностальгия",
				text = { "Разделить Множ.", "на уровень разыгранной руки" },
			},
			bl_cry_pin = {
				name = "Булавка",
				text = {
			...
			bl_cry_pinkbow = {
				name = "Бантик",
				text = { "Картам присваивается случайная", "" },
			},
			...
			bl_cry_shackle = {
				name = "Кандалы 2.0",
				text = { "Все негативные джокеры", "ослаблены" },
			},
			bl_cry_striker = {
				name = "Нападающий",
				text = { "Все редкие джокеры", "ослаблены" },
			},
			bl_cry_tax = {
				name = "Налог",
				text = { "Максимальные очки за руку", "0.4X требований блайнда" },
			},
			bl_cry_tornado = {
				name = "Бирюзовый торнадо",
				text = { "#1# в #2# шанс что", "руку не посчитает" },
			},
			bl_cry_trick = {
				name = "Трюк",
				text = {
			...
			bl_cry_vermillion_virus = {
				...
				text = { "Один случайный джокер", "заменяется каждую руку" },
			},
			bl_cry_windmill = {
				name = "Мельница",
				text = { "Все необычные джокеры", "ослаблены" },
			},
			bl_cry_scorch = {
				name = "Ожог",
				text = {
			...
			bl_cry_greed = {
				name = "Жадность",
				text = {
					"+(0.25X баз.) требования блайнда",
					"за каждие $5 когда выбран",
				},
			},
			bl_cry_decision = {
				name = "Решение",
				text = {
					"Закрепите джокеров при игре или сбросе",
					"Откройте «Злобный набор шута»",
					"после раунда.",
				},
			},
			bl_cry_repulsor = {
				name = "Репульсор",
				text = {
					"Повторно активируйте крайний правый и",
					"крайний левый джокеры, остальные джокеры не активируются.",
				},
			},
			bl_cry_chromatic = {
				name = "Хроматический",
				text = { "Счёт нечётных рук вычитается" },
			},
			bl_cry_landlord = {
				name = "Помещик",
				text = {
					"Cлучайный джокер",
					"становится прокатным",
					"когда сыграна рука",
				},
			},
			bl_cry_trophy = {
				name = "Лимонный трофей",
				text = { "Множ. не может", "превысить фишки" },
			},
		},
		...
		Joker = {
			...
			j_cry_discreet = {
				...
				text = hand_contains("{C:chips}+#1#{} Фишек, если рука"),
			},
			j_cry_filler = {
				name = "Наполнитель",
				text = hand_contains("{X:mult,C:white} X#1# {} Множ., если рука"),
				unlock = {
					"Выграть партию",
					"не сыграв",
					"{E:1,C:attention}Старшая карта",
				},
			},
			j_cry_foxy = {
				name = "Хитрый джокер",
			...
			j_cry_home = {
				name = "Дом",
				text = hand_contains("{X:mult,C:white} X#1# {} множ. если сыгранная"),
				unlock = { "Выграть партию", "не сыграв", "{E:1,C:attention}Фулл-хаус" },
			},
			j_cry_kooky = {
				name = "Чудаковатый джокер",
				text = hand_contains("{C:red}+#1#{} множ. если сыгранная\nрука"),
			},
			j_cry_manic = {
			...
			j_cry_nuts = {
				name = "Сумасшествие",
				text = hand_contains("{X:mult,C:white} X#1# {} Множ., если рука"),
				unlock = { "Выграть партию", "не сыграв", "{E:1,C:attention}Стрит-флеш" },
			},
			j_cry_quintet = {
				name = "Квинтет",
				text = hand_contains("{X:mult,C:white} X#1# {} Множ., если рука"),
				unlock = {
					...
					"{E:1,C:attention}Пять одного вида",
				},
			},
			j_cry_swarm = {
				name = "Рой",
			...
			j_cry_unity = {
				...
				unlock = {
					"Победите когда",
					"вашей последней рукой был",
					"{E:1,C:attention}Флеш-xаус",
				},
			},
			j_cry_duos = {
				name = "Пары",
				text = hand_contains("{X:mult,C:white} X#1# {} Множ., если рука"),
				unlock = { "Выграть партию", "не сыграв", "{E:1,C:attention}Две пары" },
			},
			j_cry_nutty = {
			...
			j_cry_words_cant_even = {
				name = "Словами невозможно описать этого Джокера.",
				text = hand_contains("{X:mult,C:white} X#1# {} Множ., если рука"),
			},
			j_cry_many_lost_minds = {
				name = "Многие сошли с ума, пытаясь понять этого джокера.",
				text = hand_contains("{C:chips}+#1#{} Фишек, если рука"),
			},

			j_cry_fuckedup = {
				name = Cryptid_config.family_mode and "Аккуратный джокер"
					or "Бардачный джокер",
				text = hand_contains("{C:red}+#1#{} Множ., если рука"),
			},
			j_cry_stronghold = {
			...
			j_cry_caeruleum = {
				...
				text = {
					...
					"{C:inactive}(Масштабируется через тетрацию и дальше)",
				},
			},
			j_cry_spaceglobe = {
				name = "Небесный шар",
		...
		Planet = {
			...
			c_cry_universe = {
				name = Cryptid_config.family_mode and "Вселенная"
					or "Вся Грёбаная Вселенная",
				text = {
		...
		Stake = {
			...
			stake_cry_brown = {
				...
				colour = "Коричневая",
				text = { "Все {C:attention}наклейки{} совместимы", "друг с другом" },
			},
			stake_cry_yellow = {
				name = "Желтая ставка",
				colour = "Желтая",
				text = {
					"{C:attention}Наклейки{} могут появляться на",
			...
			stake_cry_jade = {
				...
				colour = "Нефрит",
				text = { "Карты могут раздаваться {C:attention}рубашкой вверх" },
			},
			stake_cry_cyan = {
				name = "Голубая ставка",
				colour = "Голубая",
			...
			stake_cry_gray = {
				...
				colour = "Серая",
				text = {
					"Стоимость каждого повторного броска увеличивается на {C:attention}$2{}",
				},
			},
			stake_cry_crimson = {
				name = "Багровая ставка",
				colour = "Багровая",
				text = { "Ваучеры пополняются на {C:attention}чётных{} Анте" },
			},
			stake_cry_diamond = {
				name = "Алмазная ставка",
				colour = "Алмазная",
				text = { "Нужно пройти Анте {C:attention}10{} для победы" },
			},
			stake_cry_amber = {
				name = "Янтарная ставка",
				colour = "Янтарная",
				text = { "{C:attention}-1{} слот бустерного набора" },
			},
			stake_cry_bronze = {
				name = "Бронзовая ставка",
				colour = "Бронзовая",
				text = { "Ваучеры на {C:attention}50%{} дороже" },
			},
			stake_cry_quartz = {
				...
				text = {
					...
					"{s:0.8,C:inactive}(Остаётся прикреплённым к крайней левой позиции){}",
				},
			},
			stake_cry_ruby = {
			...
			stake_cry_glass = {
				...
				colour = "Стеклянная",
				text = { "Карты могут {C:attention}разбиться{} при подсчёте" },
			},
			stake_cry_sapphire = {
				name = "Сапфировая ставка",
				colour = "Сапфировая",
				text = {
					"Потерять {C:attention}25%{} текущих денег",
					"в конце Анте",
			...
			stake_cry_emerald = {
				...
				colour = "Изумрудная",
				text = {
					"Карты, паки и ваучеры",
					"могут быть {C:attention}рубашкой вверх",
					"{s:0.8,C:inactive}(Нельзя увидеть до покупки){}",
				},
			},
			stake_cry_platinum = {
				name = "Платиновая ставка",
				colour = "Платиновая",
				text = { "Малые блайнды {C:attention}убраны" },
			},
			stake_cry_twilight = {
				name = "Сумеречная ставка",
				colour = "Сумеречная",
				text = {
					"Карты могут быть {C:attention}Бананом",
					"{s:0.8,C:inactive}(1 из 10 шанс уничтожения каждый раунд){}",
				},
			},
			stake_cry_verdant = {
				name = "Незрелая ставка",
				colour = "Незрелая",
				text = {
					"Требуемые очки растут",
					"быстрее с каждым {C:attention}Анте",
			...
			stake_cry_dawn = {
				...
				colour = "Рассветная",
				text = {
					"Таро и Призраки нацеливают {C:attention}на 1",
					"карту меньше",
			...
			stake_cry_blossom = {
				...
				colour = "Цветущая",
				text = {
					"{C:attention}Финальные{} Босс-блайнды могут появляться",
			...
			stake_cry_azure = {
				...
				colour = "Лазурная",
				text = { "Значения на джокерах уменьшены", "на {C:attention}20%{}" },
			},
			stake_cry_ascendant = {
				name = "Вознесённая ставка",
				colour = "Вознесённая",
				text = { "{C:attention}-1{} слот магазина" },
			},
		},
		...
		Tag = {
			...
			tag_cry_oversat = {
				...
				text = edition_tag("Перенасыщенным"),
			},
			...
			tag_cry_clone = {
				...
				text = {
					"Товары в магазине стоят в {C:attention}1.5",
					"раза дороже, получите {C:attention}копию",
					"следующей купленной карты",
				},
			},
			tag_cry_palette_cleanser = {
				name = "Очищающий тег",
				text = {
					"Убирает {C:attention}случайную",
					"наклейку со {C:attention}случайного",
					"джокера или игральной карты",
				},
			},
			tag_cry_lens = {
				name = "Тег линзы",
				text = {
					"Добавляет {C:dark_edition}Негативный",
					"к {C:attention}2 случайным",
					"расходникам",
				},
			},
		},
		...
		Tarot = {
			...
			c_cry_seraph = {
				name = "Серафим",
				text = {
					"Улучшает {C:attention}2{} выбранные карты",
					"в: {C:attention}Световые Карты",
				},
			},
			c_cry_instability = {
				name = "Нестабильность",
		...
		Other = {
			...
			cry_perishable_booster = booster_sticker(
				"Скоропортящийся",
				"Скоропортящимися"
			),
			...
			cry_rental_voucher = {
				name = "Аренда",
				text = { "Потеряйте {C:money}$#1#{} в конце раунда" },
			},
			cry_pinned_voucher = {
				name = "Закреплённый",
				text = { "Остаётся в магазине", "до использования" },
			},
			cry_banana_voucher = {
				name = "Банан",
				text = { "{C:green}#1# к #2#{} шанс", "не активироваться этот раунд" },
			},

			-- Наклейки расходников
			cry_perishable_consumeable = {
				name = "Скоропортящийся",
				text = { "Ослаблен в", "конце раунда" },
			},
			cry_rental_consumeable = {
				name = "Аренда",
				text = {
					"Потеряйте {C:money}$#1#{} в конце",
			...
			cry_banana_consumeable = {
				...
				text = {
					"{C:green}#1# к #2#{} шанс",
					"ничего не сделать при использовании",
				},
			},
			...
			p_cry_meme_1 = {
				name = "Мемный набор",
				text = { "Выберите {C:attention}#1#{} из", "{C:attention}#2# Мем-джокеров" },
			},
			p_cry_meme_two = {
				name = "Мемный набор",
				text = { "Выберите {C:attention}#1#{} из", "{C:attention}#2# Мем-джокеров" },
	...
	misc = {
		...
		poker_hands = {
			...
			["cry_WholeDeck"] = Cryptid_config.family_mode and "Вся колода"
				or "Вся грёбаная колода",
		...
		poker_hand_descriptions = {
			...
			["cry_Declare0_suitless"] = {
				"Всегда считается Стритом",
				"Руки не требуют специальные масти",
			},
			["cry_Declare1_suitless"] = {
				"Всегда считается Флешом",
				"Руки не требуют специальные масти",
			},
			["cry_Declare2_suitless"] = {
				"Всегда считается Фулл-хаусом",
				"Руки не требуют специальные масти",
			},
		},
		dictionary = {
			...
			k_planet_universe = Cryptid_config.family_mode and "Вселенная"
				or "Вся Грёбаная Вселенная",
		...
		rnj_loc_txts = {
			...
			contexts = {
				...
				using_consumeable = {
					"при использовании {C:attention}расходуемой{} карты",
				},
				...
				individual_hand_end = {
					"за каждую карту в руке в конце {C:attention}раунда{}",
				},
			...
			conds = {
				...
				hands_left = {
					"если осталось #3# {C:blue}комбинаций{} в конце раунда",
				},
		...
		v_text = {
			...
			ch_c_cry_no_vouchers = {
				"В магазине больше не появляются {C:attention}Ваучеры{}",
			},
			ch_c_cry_no_boosters = {
				"В магазине больше не появляются {C:attention}Бустерные наборы{}",
			},
			ch_c_cry_no_rerolls = { "Перебросы {C:attention}отключены{}" },
			ch_c_cry_no_consumables = {
				"В магазине больше не появляются {C:attention}Расходники{}",
			},
		},
	},
	...
	very_fair_quips = {
		...
		{
			"СКИЛЛ ИШЬЮ",
			"ПРЕДСТАВЬ БЫТЬ ДОСТАТОЧНО ХОРОШИМ",
			"ДЛЯ ВАУЧЕРА",
		},
		...
		{
			"ОШИБКА",
			"НЕВОЗМОЖНО ВЫПОЛНИТЬ АРИФМЕТИКУ С NIL",
			"(tier4vouchers.lua)",
		},
		...
		{
			"МЫ ОТОЗВАЛИ",
			"ТВОИ ВАУЧЕРЫ — ОНИ ЛУЧШЕ",
			"ПОСЛУЖАТ В ДРУГИХ ЗАБЕГАХ",
		},
		{
			"ПОЧЕМУ ЭТО НАЗЫВАЕТСЯ ВАУЧЕР",
			"КОГДА МНОЖ ИЗ ГОРЯЧЕГО",
			"В ХОЛОДНОМ ЕШЬ ФИШКУ",
		},
		{ "ИЗВИНИ", "ВАУЧЕРЫ ПЕРЕЖИВАЮТ", "ВАУЧЕФИЮ АБОРТУС" },
		{
			"К СОЖАЛЕНИЮ",
			"ОБНОВЛЕНИЕ С ПЕРЕРАБОТКОЙ ВАУЧРХ",
			"БЫЛО ОТМЕНЕНО",
		},
		{ "ПОБЕДИ", "БОСС БЛАЙНД ЧТОБЫ", "НИЧЕГО НЕ ИЗМЕНИЛОСЬ" },
		{ "ПТИЦЫ ПОЮТ", "ЦВЕТЫ ЦВЕТУТ", "ДЕТИ ВРОДЕ ТЕБЯ..." },
		{
			"К СОЖАЛЕНИЮ СООБЩАЕМ",
			"ВСЕ ВАУЧЕРЫ ОТОЗВАНЫ",
			"ИЗ-ЗА САЛЬМОНЕЛЛЫ",
		},
		{
			"ВАУЧЕРЫ НЕ ПРИЕХАЛИ",
			"ИЗ-ЗА ТОГО ЧТО ПЛАНИРОВКА МАГАЗИНА",
			"НА 200% ПРЕВЫСИЛА БЮДЖЕТ",
		},
		...
		{
			"ВИДИШЬ ЭТУ РЕКЛАМУ?",
			"ЕСЛИ ДА — ОНА РАБОТАЕТ",
			"И ТЫ МОГ БЫ РАЗМЕСТИТЬ СВОЮ",
		},
		{
			"ТЫ УПУСКАЕШЬ",
			"КАК МИНИМУМ 5 ВАУЧЕРОВ ПРЯМО СЕЙЧАС",
			"тонктонктонктонктонк",
		},
		{ "10", "20 ВАУЧЕРОВ НЕТ XD", "30 GOTO 10" },
		{
			"ВАУЧЕРЫ —",
			"ПЛАТНАЯ ФУНКЦИЯ",
			"РАЗБЛОКИРОВАТЬ ЗА $199.99 ДЖОЛЛАРОВ",
		},
		{
			"БЕЗ ВАУЧЕРОВ ПОНАСТОЯЩЕМУ!?!?",
			"ТОЛЬКО ДЛЯ ВОСХОДЯЩЕЙ СТАВКИ",
			"ОЧЕНЬ ЧЕСТНАЯ КОЛОДА",
		},
		{
			"НРАВИТСЯ ТВОЙ",
			"ОПЫТ С ВАУЧЕРАМИ? ПОСТАВЬ НАМ",
			"ПЯТЬ ЗВЁЗД НА ДЖЕСТЕЛП",
		},
		{
			"БЕСПЛАТНЫЕ ВАУЧЕРЫ",
			"ГОРЯЧИЕ ВАУЧЕРЫ РЯДОМ С ТОБОЙ",
			"ПОЛУЧИ ВАУЧЕР БЫСТРО ОДНИМ ТРЮКОМ",
		},
		{
			"ПРЕДСТАВЛЯЕМ",
			"ПЕРВЫЙ В ИСТОРИИ ВАУЧЕР 0 УРОВНЯ!",
			"(скоро в Cryptid 1.0)",
		},
		{
			"ВАУЧЕР!",
			"ОН ПРОСТО ВООБРАЖАЕМЫЙ",
			"МЫ РЕШИЛИ ЧТО ТЫ ЭТОГО ХОТЕЛ",
		},
		{
			"ОТКЛЮЧИ АДБЛОК",
			"БЕЗ РЕКЛАМЫ МЫ НЕ СМОГЛИ БЫ",
			"ПРОДАТЬ ТЕБЕ ВАУЧЕРЫ",
		},
		{ "ЕСЛИ ЕСТЬ", "ПРЕТЕНЗИИ — ПИШИ НАМ", "НА NORESPONSE@JMAIL.COM" },
		{
			"ДЕНЕГ НЕ ХВАТИТ",
			"НА ЭТОТ ВАУЧЕР",
			"ТАК ЗАЧЕМ МЫ ЕГО СЮДА ПОЛОЖИЛИ?",
		},
		...
		{
			"МЫ ОЧЕНЬ СОЖАЛЕЕМ",
			"ПОСЛЕДНИЙ ЧУВАК В ПАНИКЕ СКУПИЛ",
			"ВСЕ ВАУЧЕРЫ",
		},
